      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-lg text-primary-lightGray2 text-center">
            Traditional business cards are slow, hard to track, and offer little
            control. Without real-time visibility, spending can quickly become
            messy. Verzo’s virtual cards give you instant access, smart limits,
            and clear tracking so every payment stays organized.
          </p>
        </div>
      </div>
    </section>
