...
const features: Feature[] = [
  {
    title: "Purchase Tracking Made Effortless",
    description:
      "Never lose track of where your money goes. Take a photo of receipts, categorise your expenses, and watch Verzo organise everything for you.",
    image: "/Purchase.png",
  },
  {
    title: "Record purchase quickly",
    description:
    ...
    <section className="w-full py-12 md:py-20 bg-primary-bgTint">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-primary-brandBlue text-center mb-8 md:mb-12 leading-tight">
          Start with the best purchasing tool
        </h2>
