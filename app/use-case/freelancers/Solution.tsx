import FreelancerTool1 from "@/public/Freelancer-tool-1";
import FreelancerTool2 from "@/public/Freelancer-tool-2";
import FreelancerTool3 from "@/public/Freelancer-tool-3";
    ...
    <section className="w-full py-12 md:py-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-[22px] text-primary-greyBold py-6 max-w-5xl mx-auto text-center">
          Daniel started using Verzo features that directly impacted his
          freelance work:
        </p>
        ...
        <div className="">
          <div className="flex row w-full items-center justify-between mb-12">
            ...
            <div className="w-1/2 ">
              <h1 className="text-[36px]">
                Manage invoices and payments across multiple clients.
              </h1>
            </div>
          </div>
          ...
          <div className="flex row w-full items-center justify-between mb-12">
            <div className="w-1/2">
              <h1 className="text-[36px]">
                Invoices to send professional, branded bills with payment links
          ...
          <div className="flex row w-full items-center justify-between">
            ...
            <div className="w-1/2 ">
              <h1 className="text-[36px]">
                Virtual Cards to separate design tool subscriptions from
                personal finances.
              </h1>
            </div>
          </div>
