...
const slides = [
  {
    header: "Expense",
    title: "Turn Every Expense Into Business Clarity",
    description:
      "From one-off costs to major purchases, every spend is documented and structured so you make confident decisions",
